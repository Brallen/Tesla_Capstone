    ...
    teslajs.vehicleDataAsync(JSON.parse(options))
        .then(function (vehicleData) {
            ...
            res.send({
                ...
                option_codes: 'AD15,MDLX,PBSB,RENA,BT37,ID3W,RF3G,S3PB,DRLH,DV2W,W39B,APF0,COUS,BC3B,CH07,PC30,FC3P,FG31,GLFR,HL31,HM31,IL31,LTPB,MR31,FM3B,RS3H,SA3P,STCP,SC04,SU3C,T3CA,TW00,TM00,UT3P,WR00,AU3P,APH3,AF00,ZCST,MI00,CDM0',
                color: null,
